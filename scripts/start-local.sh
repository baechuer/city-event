...
common_env=(
  ...
  "RATE_LIMIT_REDIS_TIMEOUT=${RATE_LIMIT_REDIS_TIMEOUT:-200ms}"
  "RATE_LIMIT_REDIS_FAIL_OPEN=${RATE_LIMIT_REDIS_FAIL_OPEN:-true}"
  "RATE_LIMIT_REQUESTS=${RATE_LIMIT_REQUESTS:-600}"
  "RATE_LIMIT_AUTH_REQUESTS=${RATE_LIMIT_AUTH_REQUESTS:-60}"
  "RATE_LIMIT_MUTATION_REQUESTS=${RATE_LIMIT_MUTATION_REQUESTS:-240}"
