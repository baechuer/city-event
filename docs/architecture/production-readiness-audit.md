...
| P0 | Kubernetes security hardening incomplete | Manifests do not yet define NetworkPolicies, pod/container security contexts, service account restrictions, HPA, topology spread, or production ingress controls. | Add restricted security contexts, `automountServiceAccountToken: false` where possible, NetworkPolicies, HPA, topology spread/anti-affinity, ingress rate limits, HSTS, and production namespaces. |
